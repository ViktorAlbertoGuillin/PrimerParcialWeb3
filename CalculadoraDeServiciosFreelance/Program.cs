using CalculadoraDeServiciosFreelanceRepositorio;
using CalculadoraDeServiciosFreelanceRepositorio.Interfaces;
using CalculadoraDeServiciosFreelanceServicio;
...
app.MapControllerRoute(
    name: "default",
    pattern: "{controller=Principal}/{action=BienvenidosArtificiales}/{id?}");
